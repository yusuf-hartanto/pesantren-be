...
export const down = async (queryInterface: QueryInterface) => {
  ...
  await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_kegiatan_akademik_status";');
  await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_kegiatan_akademik_berlaku_untuk";');
};
