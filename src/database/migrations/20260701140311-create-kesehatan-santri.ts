...
export const up = async (queryInterface: QueryInterface) => {
  ...
  try {
    await queryInterface.createTable('kesehatan_santri', {
      id_kesehatan: {
    ...
    await queryInterface.addIndex('kesehatan_santri', ['id_santri', 'progres_status'], {
      name: 'idx_kesehatan_santri_progres',
      transaction,
    });
    await queryInterface.addIndex('kesehatan_santri', ['id_pegawai', 'progres_status'], {
