...
router.get('/kegiatan-akademik/all-data', auth.checkBearerToken, kegiatanAkademik.list);
router.get('/kegiatan-akademik', auth.checkBearerToken, kegiatanAkademik.index);
router.get('/kegiatan-akademik/:id', auth.checkBearerToken, kegiatanAkademik.detail);
router.post('/kegiatan-akademik', auth.checkBearerToken, kegiatanAkademik.create);
router.put('/kegiatan-akademik/:id', auth.checkBearerToken, kegiatanAkademik.update);
router.delete('/kegiatan-akademik/:id', auth.checkBearerToken, kegiatanAkademik.delete);

router.get('/program-pesantren/all-data', auth.checkBearerToken, programPesantren.list);
router.get('/program-pesantren', auth.checkBearerToken, programPesantren.index);
router.get('/program-pesantren/:id', auth.checkBearerToken, programPesantren.detail);
router.post('/program-pesantren', auth.checkBearerToken, programPesantren.create);
router.put('/program-pesantren/:id', auth.checkBearerToken, programPesantren.update);
router.delete('/program-pesantren/:id', auth.checkBearerToken, programPesantren.delete);

router.get('/santri-program/all-data', auth.checkBearerToken, santriProgram.list);
...
router.delete('/santri-program/:id', auth.checkBearerToken, santriProgram.delete);

router.get('/orang-tua-wali/all-data', auth.checkBearerToken, orangTuaWali.list);
...
router.delete('/orang-tua-wali/:id', auth.checkBearerToken, orangTuaWali.delete);
