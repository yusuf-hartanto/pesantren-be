...
export const orgUnitBaseSchema = z.object({
  nama_orgunit: z
    .string()
...
export const orgUnitSchema = orgUnitBaseSchema.superRefine((data, ctx) => {
...
export const orgUnitUpdateSchema = orgUnitBaseSchema
  .partial()
